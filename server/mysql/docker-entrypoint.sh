...
sed -i "s|SERVER_HOST|${SERVER_HOST}|g" /docker-entrypoint-initdb.d/init.sql
sed -i "s|GAME_SERVER_PORT|${GAME_SERVER_PORT}|g" /docker-entrypoint-initdb.d/init.sql
sed -i "s|MYSQL_GAME_SCHEMA|${MYSQL_GAME_SCHEMA}|g" /docker-entrypoint-initdb.d/init.sql
sed -i "s|MYSQL_LOGIN_SCHEMA|${MYSQL_LOGIN_SCHEMA}|g" /docker-entrypoint-initdb.d/init.sql
